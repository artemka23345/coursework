...
public class Main {
    public static void main(String[] args) {
        ...
        emp.info(emp.getStorage());
        emp.allInfo();
        emp.indexSalary(1.1);//Повышаем зарплату на 10 процентов
        System.out.println("Зарплатный фонд: " + emp.monthlySalary());

        System.out.println("Минимальная зарплата: " + emp.minSalary(emp.getStorage()));
        System.out.println("Максимальная зарплата: " + emp.maxSalary(emp.getStorage()));
